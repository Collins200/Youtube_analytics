...
def mainn():
    ...
    geo=valll
    place=vall
    pytrends.build_payload(keyword,timeframe=f'2020-02-26 {date.today()}', gprop = 'youtube', geo=geo)
    ...
    pytrend.build_payload(keyword,timeframe=f'2020-02-26 {date.today()}', gprop = 'youtube', geo='')
